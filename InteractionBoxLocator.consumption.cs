...
{
    public partial class InteractionBoxLocator
    {
        /// <summary>
        /// model input class for InteractionBoxLocator.
        /// </summary>
        #region model input class
        public class ModelInput
        {
            public const int ImageTransformX = 800;

            public const int ImageTransformY = 600;

            [ColumnName(@"Label")]
            public string Label { get; set; }

            [ColumnName(@"ImageSource")]
            [Microsoft.ML.Transforms.Image.ImageType(ImageTransformX, ImageTransformY)]
        ...
        /// <summary>
        /// model output class for InteractionBoxLocator.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            public string[] ObjectTags = new string[] { "--bg--", "Interaction Box", };
        ...
        private static string MLNetModelPath = Path.GetFullPath("InteractionBoxLocator.zip");
